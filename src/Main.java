...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {		
			 ...
			 */
			Persona persona = new Persona(edadAct, nombre);
			...
			if (edadJub <= 0) { //si menor o igual a cero
				System.out.println( nombre + "¡Jubilate!  Te has pasado " + Math.abs(edadJub) + " año/s" );
			}
			else if (edadJub>=10) { //si mayor o igual a 10
				System.out.println(nombre +"Te quedan " + edadJub + " años. ¡A seguir trabajando gandúl!");
			}
			else if (edadJub <10){ // si menor a 10
				System.out.println (nombre +"Sólo te quedan " + edadJub + " años. ¡Vamos que ya queda poco!");
			} 
		} 
		/**
